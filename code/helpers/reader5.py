...
from helpers import json_util as ju
...
import nltk
#LIAR-PLUS
ROOT_PROJ_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "/dataset/RAWFC"
#ROOT_PROJ_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "/dataset/LIAW-RAW"
...
class myDataset(Dataset):
    # def __init__(self, data_file, lm_emb, report_each_claim=15):
...
if __name__ == '__main__':
    ...
    import DistilEmbeddings, list2str
