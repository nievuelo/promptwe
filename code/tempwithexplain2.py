    ...
    for i in range(lng):
        if(len(raw_dataset[name][0][i])>400):
            dataset[name].append(
                InputExample(
                    guid = i,
                    text_a = raw_dataset[name][0][i][0][:400],
