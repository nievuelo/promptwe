...
def evaluate_model(model, data_url, bsl_model=None, criterion=None, sent_criterion=None, doc_criterion=None, log=None, top_k=4, report_each_claim=6):
    ...
    with torch.no_grad():
        ...
        # need to be recovered
        with open('rawfc04train.json', 'w', encoding='UTF-8') as fp:
...
def main():
    #
    model_url = "/home/workstation-14/zxr/CofCED-test/Codes/RAWFC_model_epoch6_pre0.465000_rec0.465000_micf0.465000_macf0.460664_rouge0.094902.pt"
    # test_url = from_project_root("dataset/pub_oracles/ruling_oracles_test_checked.tsv")
    test_url = from_project_root("dataset/RAWFC/train/")
